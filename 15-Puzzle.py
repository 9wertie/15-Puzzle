...
loc = [[[10,10],[110,10],[210,10],[310,10]],
       [[10,110],[110,110],[210,110],[310,110]],
       [[10,210],[110,210],[210,210],[310,210]],
       [[10,310],[110,310],[210,310],[310,310]]]
...
def block(i,j,n):
    if n!=15:
        moraba = pygame.Rect(loc[i][j][0],loc[i][j][1],90,90) # [i][j][0] = x [i][j][1] = y
